...
export default function Me() {
  return (
    <>
      <div id="me" className="min-h-screen overflow-y-hidden flex flex-col items-center justify-center bg-[#001F3F]">
        {/* Conteneur principal */}
          ...
          <div className="mt-8 md:mt-0 relative w-56 h-56 sm:w-72 sm:h-72 mx-auto">
            <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
              <div className="flex flex-wrap justify-center items-center relative z-10">
                <DiReact size={40} className="m-1 sm:m-2 text-[#3b82f6]" />
                <SiJavascript size={40} className="m-1 sm:m-2 text-[#f59e0b]" />
                <DiHtml5 size={40} className="m-1 sm:m-2 text-[#f97316]" />
                <DiCss3 size={40} className="m-1 sm:m-2 text-[#2563eb]" />
                <DiGit size={40} className="m-1 sm:m-2 text-[#ea580c]" />
                <FaGithub size={40} className="m-1 sm:m-2 text-[#181717]" />
                <SiNextdotjs size={40} className="m-1 sm:m-2 text-[#000000]" />
                <SiNestjs size={40} className="m-1 sm:m-2 text-[#e11d48]" />
                <SiTypescript size={40} className="m-1 sm:m-2 text-[#1e40af]" />
                <SiMongodb size={40} className="m-1 sm:m-2 text-[#4caf50]" />
                <SiFlutter size={40} className="m-1 sm:m-2 text-[#02569b]" />
              </div>
            </div>
            {/* Forme de cœur */}
